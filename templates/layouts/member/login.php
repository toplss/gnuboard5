...
<!-- 로그인 후 아웃로그인 시작 { -->
    ...
    <header id="ol_after_hd">
        ...
        <?php if ($is_admin == 'super' || $is_auth) :  ?><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="btn_admin btn" title="관리자"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a><?php endif  ?>
    </header>
...
<script src="/templates/js/member.login.js"></script>
<!-- } 로그인 후 아웃로그인 끝 -->
